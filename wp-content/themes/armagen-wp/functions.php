 ...
 * Management Team
*/
add_action( 'init', 'create_post_type_management' );
function create_post_type_management() {
register_post_type( 'Management Team Member',
    array(
    'labels'             => array(
    'name'               => __( 'Management Team Members' ),
    'singular_name'      => __( 'Management Team Member' ),    
    'add_new'            => _x( 'Add Management Team Member', 'Management Team Members' ),
    'add_new_item'       => __( 'Add Management Team Member' ),
    'edit_item'          => __( 'Edit Management Team Member' ),
    'new_item'           => __( 'New Management Team Member' ),
    'view_item'          => __( 'View Management Team Member' ),
    'search_items'       => __( 'Search Management Team Members' ),
    'not_found'          => __( 'No Management Team Members found' ),
    'not_found_in_trash' => __( 'No Management Team Members found in Trash' ),
    'parent_item_colon'  => ''
    ),
    'public'    => true,
    'supports'  => array('title','editor','thumbnail' ),
