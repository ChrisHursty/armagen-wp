 ...
 */
function armagen_template_chooser( $template ) {
...
add_filter( 'template_include', 'armagen_template_chooser' );
 ...
 */
function armagen_body_class( $classes ) {
...
add_filter( 'body_class','armagen_body_class' );

/**
 * Helper function for displaying image
 */
function armagen_display_image() {
 ...
 * @param object $post
 */
function armagen_display_gallery( $post ) {
